        ...
        <header class="header header-light header-layout2">
                ...
                <div class="row">
                    ...
                    <div class="header__topbar-right-inner d-flex flex-wrap justify-content-between">
                        ...
                        <li>
                            ...
                            <a href="tel:064 233981">064 233981</a>
                        </li>
                        <li>
                            <i class="icon-envelope"></i><span>Email:</span>
                            <a href="Promine:micensac@mineracentro.com">micensac@mineracentro.com</a>
                        </li>
                        <li><i class="icon-clock"></i><span>Hours: Lun-Sab: 8am – 7pm</span></li>
                        </ul>
                    </div>
                    </div><!-- /.col-lg-7 -->
                </div><!-- /.row -->
            ...
            <nav class="navbar navbar-expand-lg sticky-navbar">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="assets/images/logo/logo01_1.png" class="logo-light" alt="logo">
                    <img src="assets/images/logo/logo01_1.png" class="logo-dark" alt="logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="mainNavigation">
                    ...
                    <li class="nav__item with-dropdown">
                        <a href="nosotros.php" class="dropdown-toggle nav__item-link">Nosotros</a>
                        
                    </li><!-- /.nav-item -->
                    <li class="nav__item with-dropdown">
                        <a href="services.php" class="dropdown-toggle nav__item-link">Servicios</a>
                ...
                <ul class="actions__list list-unstyled d-flex align-items-center mb-0 ml-30">
                    <li>
                    <a href="contacs.php" class="btn btn__primary action__btn-request">
                        <span>Contactanos</span><i class="icon-arrow-right"></i>
                    </a>
                    </li>
